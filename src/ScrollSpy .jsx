function ScrollSpy(){
  ...
  <div class="col-4">
    <div id="simple-list-example" class="d-flex flex-column gap-2 simple-list-example-scrollspy text-center">
      <a class="p-1 rounded" href="#simple-list-item-1">About ME</a>
      <a class="p-1 rounded" href="#simple-list-item-2">Qualification</a>
      <a class="p-1 rounded" href="#simple-list-item-3">Contact Info</a>
